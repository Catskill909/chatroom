...
export const Chatroom = () => {
  ...
  // Handle avatar updates with improved stability
  const handleAvatarChange = useCallback((newAvatar: string | null) => {
    if (!socket || !currentUser) return;

    console.log('[handleAvatarChange] Updating avatar for', currentUser);
    ...
    // Notify the server about the avatar change - simplified approach
    if (socket.connected) {
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="space-x-2">
                    <Button 
                      ...
                      size="sm"
                      onClick={() => {
                        // Simple avatar change for testing - no complex reconnection logic
